...
const SupplierMachineSchema = Schema({
    ...
    spm: {type: Number, required: false, default: 0},
    ...
    materials: {type: Array, required: false, default: []},
    printable_frame_length_min: {type: Number, required: false, default: 0},
    printable_frame_length_max: {type: Number, required: false, default: 0},
