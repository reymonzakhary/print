<template>
  <div v-if="isLoading" class="input p-1">
  ...
  <select
    ...
    :name="name"
    :value="inputValue"
    class="w-full rounded border px-2 py-1 text-black focus:border-theme-300 focus:outline-none focus:ring dark:border-gray-900 dark:bg-gray-700 dark:text-white"
    :class="{
      'border-1 border-red-500 text-red-500': errors.length > 0,
      '!hover:bg-gray-100 cursor-not-allowed !bg-gray-100': disabled,
      'bg-red': !disabled,
    }"
    :disabled="disabled"
