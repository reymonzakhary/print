export default {
  computed: {
     ...
     */
    selectedItems() {
      return this.$store.getters["fm/content/selectedItems"];
    },
     ...
     */
    selectedDiskDriver() {
      return this.$store.state.fm.filemanager.disks[this.selectedDisk]?.driver;
    },
     ...
     */
    multiSelect() {
      return this.$store.getters["fm/content/selectedList"].length > 1;
    },
     ...
     */
    firstItemType() {
      return this.$store.getters["fm/content/selectedList"][0]?.type;
    },
  },
