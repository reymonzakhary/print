...
use Modules\Cms\Observers\Chunk\ChunkObserver;
use Modules\Cms\Observers\Resource\ResourceObserver;
...
class CmsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('cms', function() {
            return new Cms(request(), session(), cache());
        });

        $this->app->bind('cacheable', function () {
            return new Cacheable(cache());
        });
    }
