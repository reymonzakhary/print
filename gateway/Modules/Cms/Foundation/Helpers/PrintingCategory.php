...
class PrintingCategory extends SnippetContract
{
    ...
    public function __construct()
    {
        ...
        $category = optional(collect($this->resource->content)->filter(fn ($item) => $item['key'] == BlockKeysEnum::BOOPS->value)->first())['value'];
    ...
    public function getChunk()
    {
        ...
        return (new Compiler($this->resource))->compileHelperClasses((new SyntaxAnalyzer($this->category))->injectModel($tpl)->resolve()->getHtml());
    }
}
