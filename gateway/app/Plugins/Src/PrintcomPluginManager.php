...
use App\Plugins\Util\Printcom\DataMapper;
use App\Plugins\Util\Printcom\ResponseValidator;
use GuzzleHttp\Exception\GuzzleException;
use Illuminate\Support\Facades\Log;
use RuntimeException;

final class PrintcomPluginManager extends PluginManager
{
        ...
        return [
            ...
            [
                ...
                "action" => [
                    ...
                    "input" => [
                        "from" => 'RetrieveDataAction.RetrieveData',
                    ],
                ],
            ],
        ];
    ...
    ): array
    {
        ...
        $options = $this->dataMapper->mapProductVariationsStructureFromPrindustryToPrintCom(
            $quantity,
            $productData,
            $categoryData
        );
        ...
        try {
            ...
            Log::debug('Failed to retrieve price from print.com', [
                'quantity' => $quantity,
                'response' => $response,
            ]);
        ...
        return $this->dataMapper->mapPriceResultDataStructureFromPrintComToPrindustry($quantity, $response['data']);
    }
