...
use App\Http\Resources\OrderItems\OrderItemResource;
...
class ItemResource extends JsonResource
{
    ...
    {
        return tap(new ItemResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request)
    {
        return $this->filterFields([
            'id' => $this->id,
            'product' => ProductItemResource::make($this->product),
            'vat' => $this->vat,
            ...
            'item_children' => OrderItemResource::collection($this->whenLoaded('children'))->hide([]),
