...
use App\Http\Resources\Orders\OrderCustomerResource;
...
final class OrderItemResource extends JsonResource
{
    ...
    {
        return tap(new OrderItemResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request)
    {
        ...
        return $this->filterFields([
            ...
            'item_children' => OrderItemChildrenResource::collection($this->whenLoaded('children'))->hide([]),
            ...
            'services' => OrderItemServiceResource::collection($this->whenLoaded('services')),
