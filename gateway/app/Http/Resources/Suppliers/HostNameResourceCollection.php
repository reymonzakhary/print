...
class HostNameResourceCollection extends ResourceCollection
{
    ...
    {
        return $this->collection->map(fn(HostNameResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
