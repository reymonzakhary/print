...
class ContractResourceCollection extends ResourceCollection
{
    /**
     * @var array
     */
    ...
    {
        return $this->collection->map(fn(ContractResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
