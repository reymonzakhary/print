...
class VariationResourceCollection extends ResourceCollection
{
    /**
     * @var array
     */
    ...
    {
        return $this->collection->map(fn (VariationResource $resource) =>
            $resource->hide($this->withoutFields)->toArray($request)
        )->all();
    }
}
