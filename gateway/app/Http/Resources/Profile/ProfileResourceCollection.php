...
class ProfileResourceCollection extends ResourceCollection
{
    /**
     * @var array
     */
    ...
    {
        return $this->collection->map(fn(ProfileResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
