...
class OptionResourceCollection extends ResourceCollection
{
    /**
     * @var array
     */
    ...
    {
        return $this->collection->map(fn(OptionResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
