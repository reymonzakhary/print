...
use App\Http\Resources\Categories\LinkedSupplierResource;
...
class SystemOptionResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    {
        return tap(new SystemOptionResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            "dimension" => data_get($this->resource, 'dimension'),
            "dynamic" => data_get($this->resource, 'dynamic', false),
            "dynamic_keys" => data_get($this->resource, 'dynamic_keys', []),
            "start_on" => data_get($this->resource, 'start_on', 0),
            "end_on" => data_get($this->resource, 'end_on', 0),
            "generate" => data_get($this->resource, 'generate', false),
            "dynamic_type" => data_get($this->resource, 'dynamic_type'),
            "width" => data_get($this->resource, 'width', 0),
            "maximum_width" => data_get($this->resource, 'maximum_width', 0),
            "minimum_width" => data_get($this->resource, 'minimum_width', 0),
            "height" => data_get($this->resource, 'height', 0),
            "maximum_height" => data_get($this->resource, 'maximum_height', 0),
            "minimum_height" => data_get($this->resource, 'minimum_height', 0),
            "length" => data_get($this->resource, 'length', 0),
            "maximum_length" => data_get($this->resource, 'maximum_length', 0),
            "minimum_length" => data_get($this->resource, 'minimum_length', 0),
            "unit" => data_get($this->resource, 'unit'),
            "incremental_by" => data_get($this->resource, 'incremental_by', 0),
            "published" => data_get($this->resource, 'published', true),
            "has_children" => data_get($this->resource, 'has_children', false),
            "input_type" => data_get($this->resource, 'input_type'),
            "extended_fields" => data_get($this->resource, 'extended_fields', []),
            "shareable" => data_get($this->resource, 'shareable', false),
            "parent" => data_get($this->resource, 'parent', true),
            "start_cost" => data_get($this->resource, 'start_cost', 0),
            "display_start_cost" => (new Moneys())
                ->setDecimal(5)
                ->setPrecision(5)
                ->setAmount(data_get($this->resource, 'start_cost', 0))
                ->format(),
            "calculation_method" => data_get($this->resource, 'calculation_method', []),
            "rpm" => data_get($this->resource, 'rpm', 0),
            "sheet_runs" => data_get($this->resource, 'sheet_runs', []),
            "runs" => data_get($this->resource, 'runs', []),
            "information" => data_get($this->resource, 'information'),
            "additional" => data_get($this->resource, 'additional', []),
