...
final class PrintSupplierCategoryResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    {
        return tap(new PrintSupplierCategoryResourceCollection($resource), function ($collection) {
    ...
    ): array
    {
        ...
        return [
            ...
            "price_build" => $this->priceBuild(optional($this->resource)['price_build']),
            ...
            "linked" => data_get($this->resource, 'linked', data_get($this->resource, 'linked.$oid')),
            ...
            "boops" => count(array_filter(optional($this->resource)['boops'])) ? PrintBoopsResource::collection(optional($this->resource)['boops']) : [],
            "created_at" => $this->extractAndFormatCreatedAtAttribute($this->resource)
        ];
    }

    /**
     * Process priceBuild information.
     *
     * @param mixed $priceBuild The priceBuild data to process.
     * @return array Processed priceBuild information.
     */
    public function priceBuild(
        mixed $priceBuild
    ): array
    {

        return [
            "collection" => (bool)optional($priceBuild)['collection'],
            "semi_calculation" => (bool)optional($priceBuild)['semi_calculation'],
            "full_calculation" => (bool)optional($priceBuild)['full_calculation'],
            "external_calculation" => (bool)optional($priceBuild)['external_calculation'],
        ];
    }
