...
/**
 * Class TrashedOrderResource
 * @package App\Http\Resources\TrashedOrderResource
 * @OA\Schema(
 * )
 */
final class TrashedOrderResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    public function toArray(Request $request): array
    {
        ...
        return $this->filterFields([
            ...
            ,
            'delivery_address' => AddressResource::make(
                collect($this->whenLoaded('delivery_address'))->first()
            )->hide(
            ...
            'customer' => OrderCustomerResource::make($this->whenLoaded('orderedBy'))->hide(
            ...
            'deleted_at' => $this->deleted_at ? Carbon::instance($this->deleted_at)->toISOString(true) : null,
        ...
        return $this->filterFields([
            ...
            'delivery_method' =>
                (boolean)$this->delivery_multiple ?
                    ...
                    [$this->delivery_pickup ?? 0]
            ,
            'delivery_address' => AddressResource::make(collect($this->delivery_address)->first())->hide(
                optional($this->withoutChildrenFields)['address'] ?? []
            ),
            ...
            'reseller' => '',
            'created_from' => $this->created_from,
            'locked_by' => UserResource::make($this->whenLoaded('lockedBy'))->hide(
                optional($this->withoutChildrenFields)['lockedBy'] ?? []
            ),
            'locked_at' => $this->locked_at ? Carbon::instance($this->locked_at)->toISOString(true) : null,
            'created_at' => Carbon::instance($this->created_at)->toISOString(true),
            'updated_at' => Carbon::instance($this->updated_at)->toISOString(true),
            'items' => OrderItemResource::collection($this->whenLoaded('items'))->hide(
                optional($this->withoutChildrenFields)['items'] ?? []
