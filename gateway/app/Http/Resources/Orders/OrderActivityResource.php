...
/**
 * Class OrderActivityResource
 * @package App\Http\Resources\OrderActivityResource
 * @OA\Schema(
 * )
 */
class OrderActivityResource extends JsonResource
{
    ...
    {
        return tap(new OrderActivityResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request)
    {
        $to = $this->to;
        if (
            str_contains($this->event, 'has add new item with id') || str_contains($this->event, 'has change product on item')) {
