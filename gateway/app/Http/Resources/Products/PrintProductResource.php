...
/**
 * Class PrintProductResource
 * @package App\Http\Resources\Products
 * @OA\Schema(schema="PrintProductResource",title="Print Boops Resource options")
 */
class PrintProductResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    {
        return tap(new PrintProductResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request)
    {
        ...
        return $this->filterFields([
            ...
            "prices" => optional($this->resource)['prices'] ? PrintProductPriceResource::collection(optional($this->resource)['prices']) : [],
