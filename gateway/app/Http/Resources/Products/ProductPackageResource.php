...
/**
 * Class ProductPackageResource
 * @package App\Http\Resources\Products
 * @OA\Schema(
 *     schema="ProductPackageResource",
 *     title="Product Package Resource"
 *
 * )
 */
class ProductPackageResource extends JsonResource
{
     ...
     * @OA\Property(format="string", title="products", default="[{id: 1,name: test product,}]", description="products", property="products"),
