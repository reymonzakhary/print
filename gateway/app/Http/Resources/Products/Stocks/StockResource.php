...
class StockResource extends JsonResource
{
     ...
     * @OA\Property(format="string", title="slug", default="shoes-4", description="slug", property="slug"),
     ...
     * @OA\Property(format="string", title="sku", default="4bb15dd8-32ac-4afe-a4fd-35ead368957e", description="sku", property="sku"),
     * @OA\Property(format="string", title="ean", default="2166127534854", description="ean", property="ean"),
    ...
    public function toArray($request)
    {
        return [
            ...
            'stocks' => ProductsStockResource::collection($this->stocks)
        ];
    }
}
