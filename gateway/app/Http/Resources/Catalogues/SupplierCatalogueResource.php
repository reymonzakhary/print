...
class SupplierCatalogueResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    {
        return tap(new SupplierCatalogueResourceCollection($resource), function ($collection) {
    ...
    {
        return count($this->resource) > 0 ? $this->filterFields([
            'id' => $this['_id']['$oid'],
            'name' => $this['name'],
