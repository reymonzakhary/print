...
class LexiconResourceCollection extends ResourceCollection
{
    /**
     * @var array
     */
    ...
    {
        return $this->collection->map(fn(LexiconResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
