...
class MediaSourceResourceCollection extends ResourceCollection
{
    ...
    {
        return $this->collection->map(fn(MediaSourceResource $resource) => $resource->hide($this->withoutFields)->toArray($request))->all();
    }
}
