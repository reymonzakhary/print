...
class DesignProviderTemplateResourceCollection extends ResourceCollection
{
    ...
    {
        return $this->collection->map(function (DesignProviderTemplateResource $resource) use ($request) {
