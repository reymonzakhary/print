...
class SystemBoxResource extends JsonResource
{
    /**
     * @var array
     */
    ...
    {
        return tap(new SystemBoxResourceCollection($resource), function ($collection) {
    ...
    public function toArray($request): array
    {
        return [
            ...
            "appendage" => data_get($this->resource, 'appendage'),
            "calculation_type" => data_get($this->resource, 'calculation_type'),
            "published" => data_get($this->resource, 'published'),
            "input_type" => data_get($this->resource, 'input_type'),
            "incremental" => data_get($this->resource, 'incremental'),
            "select_limit" => data_get($this->resource, 'select_limit'),
            "option_limit" => data_get($this->resource, 'option_limit'),
            ...
            "matches" => data_get($this->resource, 'matches'),
