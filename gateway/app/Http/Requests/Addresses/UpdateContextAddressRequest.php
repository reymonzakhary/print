...
final class UpdateContextAddressRequest extends FormRequest
{
    ...
    {
        if (!$this->context->addresses()->where('addresses.id', $this->route('address')->id)->exists()) {
        ...
        $this->merge([
            'default' => $this->context->addresses()->count() === 1 ?? $this->boolean('default'),
    ...
    protected function passedValidation(): void
    {
        ...
        $this->context->addresses()->detach($this->route('address'));
