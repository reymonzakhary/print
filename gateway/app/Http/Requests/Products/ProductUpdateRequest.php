...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'art_num' => 'nullable|string|max:255',
            ...
            'products.*.sku_id' => 'integer|exists:skus,id',
            ...
            'category_id' => 'exists:categories,row_id',
            'published' => 'boolean',
...
//            'variations.*.options.*.child.*.id' => 'integer|exists:options,row_id',
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'properties' => [
                'validations' => optional($this->properties)['validations'] ?? (optional($this->product->properties)['validations'] ?? []),
                'template' => optional($this->properties)['template'] ?? (optional($this->product->properties)['template'] ?? []),
                'props' => optional($this->properties)['props'] ?? (optional($this->product->properties)['props'] ?? []),
            ],
        ]);
    }
}
