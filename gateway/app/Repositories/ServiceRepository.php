...
class ServiceRepository extends InitModelAbstract implements RepositoryEloquentInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        $service = $this->model->where('id', (int)$id)->first();
        if ($service) {
            if ($service->delete()) {
                return true;
            }
