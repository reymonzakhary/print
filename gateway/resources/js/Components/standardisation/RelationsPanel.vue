            ...
            <template slot="side-panel-content">
                <div class="relative mt-4">
                    <transition name="slide">
                        <div
                            :class="
								`bg-${responseStatusColor}-500 text-${responseStatusColor}-800 rounded p-2 m-4`
							"
                    ...
                    <!-- ITEM'S RELATIONS -->
                    <div
                        class="p-4 mt-4 mb-2 text-sm font-bold tracking-wide uppercase"
                    >
                        <font-awesome-icon
                    ...
                    <ul
                        class="text-sm divide-y dark:divide-gray-900"
                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex items-center">
								<span class="flex-1" v-if="relation.category">
									{{ relation.category.name }}
								</span>

                                <font-awesome-icon
                                    :icon="['fal', 'caret-right']"
                                    class="flex-1 text-blue-500"
                                />

                                <span
                                    class="flex-1"
                                    :class="{ italic: type === 'box' }"
                                >
