                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1
                                        ...
                                        {{__('mails.new_quotation')}}
                                    </h1>

                                    <p><strong>{{__('mails.name')}}: </strong> {{$contract->name}}</p>
                                    <p><strong>{{__('mails.description')}}: </strong> {{$contract->description}}</p>
                                    <p><strong>{{__('mails.email')}}: </strong> {{$contract->email}}</p>

                                    <p><strong>{{__('mails.quotation_external_id')}}: </strong> {{$quotation->external_id}}</p>
                                    <p><strong>{{__('mails.quotation_internal_id')}}: </strong> {{$quotation->internal_id}}</p>
