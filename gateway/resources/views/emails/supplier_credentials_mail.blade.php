        ...
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; width:calc(600px);border-collapse:collapse;margin:0 auto;padding:0">
                    <tr>
                        <td class="header"
                            ...
                            <a href="#"
                                ...
                                {{__('mails.welcome_to')}} Prindustry!
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                    <tr>
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            style="text-align: center; box-sizing: border-box; border-radius: 5px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #d3e3eb; border-bottom: 1px solid #d3e3eb; border-top: 1px solid #d3e3eb; margin: 0; padding: 0; width: 100%;">
                            <h4>{{__('mails.been_invited')}}</h4>
                            <p>{{__('mails.invitation_details')}}</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="body" cellpadding="0" cellspacing="0"
                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #edf2f7; border-bottom: 1px solid #edf2f7; border-top: 1px solid #edf2f7; margin: 0 auto; padding: 16px; width: 60%;">
                            <p>{{__('mails.salutation')}} {{$name}},</p>
                            <h5>{{__('mails.credentials_heading')}}</h5>
                            <p><strong>{{__('mails.domain')}}: </strong>
                                <a href="{{$url.'/manager'}}">{{$url.'/manager'}}</a>
                            </p>
                            <p><strong>{{__('mails.email')}}: </strong> <span>{{$email}}</span></p>
                            <p><strong>{{__('mails.password')}}: </strong> <span>{{$password}}</span></p>
                        </td>
                    </tr>
                    <tr>
                        <td
