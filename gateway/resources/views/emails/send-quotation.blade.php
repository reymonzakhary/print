                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1
                                        ...
                                        {{__('mails.quotation_updated')}}: <p><strong>  #{{$external_quotation?->external_id}}</strong></p>
                                    </h1>
                                    <p><strong>{{__('Supplier quotation ID')}}: #{{$quotation->id}}</strong></p>
                                    <p><strong>{{__('updated at')}}</strong> <span>{{$quotation->updated_at}}</span>
                                </td>
                            </tr>
