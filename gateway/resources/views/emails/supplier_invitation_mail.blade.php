            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="header"
                        ...
                        <a href="https://www.prindustry.com"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1
                                        ...
                                        {{__('mails.received_invitation')}}
                                    </h1>

                                    <p>{{__('mails.salutation')}} {{$name}},</p>
                                    <p>{{__('mails.received_because')}}<strong> {{$company->name}} </strong>
                                        {{__('mails.wants_supplier')}} </p>
                                    <p>
                                        {{__('mails.if_accept')}}
                                        <strong> {{$company->name}} </strong> {{__('mails.want_to_produce')}}
                                    </p>
                                    <p>{{__('mails.work_with_them')}}</p>
                                    <div style="margin-top: 30px;">
                                        <a href="{{$acceptUrl}}"
                                        style="text-decoration: none; color:#fff; padding: 7px 15px; margin-right: 15px; background-color: #2f94b3">{{__('mails.accept')}}</a>
                                        <a href="{{$rejectUrl}}"
                                        style="text-decoration: none; color:#000; padding: 7px 15px; margin-right: 15px; background-color: #d1d5db">{{__('mails.reject')}}</a>
                                    </div>
                                </td>
                            </tr>
                        </table>
