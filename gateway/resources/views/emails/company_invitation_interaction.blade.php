                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h1
                                        ...
                                        {{__('mails.invitation_reaction')}}
                                    </h1>

                                    <p>{{__('mails.salutation')}} {{$custom_fields['company']}},</p>
                                    <p>{{$custom_fields['name']}} {{__('mails.has_reacted_to_invitation')}}</p>

                                    <div style="padding: 8px; border-radius: 8px; margin: 16px 0 8px 0; background-color: #f8f9fa; text-align: center; font-size: 1rem;">
                                        <h2>{{__('mails.invitation')}} {{$status}} </h2>
                                    </div>

                                    <p> {{__('mails.go_to_dashboard')}} </p>
                                </td>
                            </tr>
                        </table>
