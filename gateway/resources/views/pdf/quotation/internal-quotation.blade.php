...
$customer_data = $quotation->orderedBy;
...
/*
 * The product row limit is calculated by dividing the rowHeight by the height of the first page table.
 */
...
$first_product_row_limit = floor($first_table_height / $row_height) - 3;
$extra_product_row_limit = floor($extra_table_height / $row_height) - 2;
...
@section('content')
    ...
    @include('pdf.quotation.partials.table', ['items' => $products, 'is_extra_page' => false])
