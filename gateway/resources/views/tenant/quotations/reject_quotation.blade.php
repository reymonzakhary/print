...
<div class="container">
    ...
    <div class="rejection-card">
        <div class="x-circle">
            <svg class="x-mark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                 stroke="currentColor">
        ...
        <div class="header">
            ...
            <div class="quotation-number">{{ __('quotations.quotation_number') }}:
                #{{ $quotation->getAttribute('id') }}</div>
        </div>
                ...
                <p>
                    @if($customer)
                        ...
                        @if($customerDefaultAddress)
                            ...
                            <br>
                            {{ $customerDefaultAddress->getAttribute('zip_code') }}
                            , {{ $customerDefaultAddress->getAttribute('city') }}
                        @endif
                    @endif
                </p>
            </div>
