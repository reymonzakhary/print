...
class LaratrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $config = config('laratrust_system_seeder.roles_structure');
        $mapPermission = collect(config('laratrust_system_seeder.permissions_map'));
        $routePermission = collect(config('laratrust_system_seeder.permissions_by_route'));
...
//                    Npace::firstOrCreate(['name' => $namespaces[0]]);
...
//            }
            ...
            if (Config::get('laratrust_system_seeder.create_users')) {
