<template>
  <div ref="container" class="relative w-full overflow-hidden break-all grow-wrap">
    <textarea
      :class="[
        { 'bg-gray-100 hover:bg-gray-100 cursor-not-allowed': disabled },
        `max-w-full input ${backgroundColor}`,
      ]"
      :value="theValue"
      :maxlength="maxLength"
      :disabled="disabled"
    ...
    <span
      v-if="!disabled"
      class="absolute text-sm font-medium bottom-1 right-2"
      :class="{
        'text-orange-500':
